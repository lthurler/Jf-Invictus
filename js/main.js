...
sr.reveal(`#sobre-container,#social-container, #copyright, #cabo-card, #legalizacao, #rgi, #certidao, #imposto, #habite, #obra`, {delay: 600, origin:'bottom', interval: 500})
sr.reveal(`#main-text, #footer-logo img, #footer-content, #invictos-img`, {origin:'left'})
sr.reveal(`#main-img, #footer-menu, #footer-map, #main-link, #invictus-txt`, {origin:'right'})
sr.reveal(`.qualification__content, .services__card`, { interval: 100 })

// , #legalizacao-txt, #rgi-img, #certidao-txt , #legalizacao-img, #rgi-txt, #certidao-img